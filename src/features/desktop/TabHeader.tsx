...
export const TabHeader = ({icon, name, isDraggable = true}: HeaderProps) => {
    ...
    return( 
        isDraggable ? 
            <div className="handle-bar flex w-full bg-secondary-blue h-fit py-2 sm:py-3 rounded-t-[9px] items-center cursor-grab">
                ...
                <h2 className="text-white font-['Arial'] text-xl sm:text-2xl translate-y-0.5 ml-auto mr-[3%] cursor-pointer" onClick={closeTab}>[x]</h2>
            </div>
        : 
