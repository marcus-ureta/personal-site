...
export const TabHeader = ({icon, name, isDraggable = true, tab}: HeaderProps) => {
    ...
    return( 
        isDraggable ?
            <>
                <div className="handle-bar hidden sm:flex w-full bg-secondary-blue h-fit py-2 sm:py-3 rounded-t-[9px] items-center cursor-grab border-[#2c3d50] border-t-2 border-l-2 border-r-2 transition-all hover:bg-[#3b526c] hover:border-[#32465c]">
