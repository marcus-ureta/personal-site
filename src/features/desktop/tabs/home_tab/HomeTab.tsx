...
function HomeTab(){
    ...
    return(
            <div className={`w-[95vw] h-auto max-h-[640px] sm:max-h-none sm:w-[70vw] ${getTabStyle()} top-1/2 left-1/2 -translate-x-1/2 -translate-y-[49%] sm:-translate-y-[54%] animate-fade-in-up z-[var(--tabIndex-value)]`}
                style={{
                ...
                <div className="tab-scrollable block sm:contents">
                {/* TAB COMPONENTS */}
