            ...
            <div className="tab-scrollable">
                <div className='mx-[20px] sm:mx-[5%] mt-[2.5%]'>
                    ...
                    <form onSubmit={onSubmit} className='flex flex-col bg-[#F3FAFF] border-secondary-blue border-2 mt-[3%] w-full mb-[2%]'>
                        ...
                        <div className='flex flex-row justify-between mx-[3%] my-[2%] items-center'>
                            ...
                            <h3 className="font-['Jost'] text-secondary-blue text-[clamp(16px,2.5vw,26px)] italic select-none">expect a response within 2-3 business days!</h3>
                        </div>
                    </form>
                </div>
            </div>
